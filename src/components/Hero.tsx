...
type StatusBadgeProps = object

type MainTitleProps = object
...
const MainTitle = memo<MainTitleProps>(() => (
...
const Home: React.FC = () => {
  ...
  // Handle scroll to home when component mounts
  useEffect(() => {
  ...
  return (
      <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
        <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
          <div className="container mx-auto px-[5%] sm:px-8 lg:px-[5%] min-h-screen">
            <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
              {/* Left Column */}
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0 pl-4 md:pl-8 lg:pl-12"
                   data-aos="fade-right"
                   data-aos-delay="200">
