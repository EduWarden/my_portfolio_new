    ...
    >
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-gradient text-4xl font-bold mb-4">Hello, I'm <br /><span className="text-white text-5xl mt-2 block">Nurgissa Bazarali</span></h2>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  >
                    <span className="w-2 h-2 bg-portfolio-purple rounded-full" />
                    {item}
                  </li>
                ))}
              </ul>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 bg-black/50 backdrop-blur-sm border border-white/10 px-6 py-4 rounded-lg">
              <div className="text-sm text-gray-400">Experience</div>
              <div className="text-2xl font-bold">3+ Years</div>
            </div>
            
            <div className="absolute -top-8 -left-8 bg-black/50 backdrop-blur-sm border border-white/10 px-6 py-4 rounded-lg">
